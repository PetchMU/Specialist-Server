...
<div class="container">
    <?php if ($rejectsend): ?>
        <div class="collection-item red lighten-3" style="color:#fff">Your rejection request was submitted</div>
    <?php endif; ?>
    <div class="row">
            ...
            <div class="col s4 m3">
                <a href="/user/<?= $member['uid'] ?>">
                    <div class="card">
                        ...
                        <form action="/group/<?= $gid ?>/member/<?= $member['uid'] ?>/reject" method="POST">
